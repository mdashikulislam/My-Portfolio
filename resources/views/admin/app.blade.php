    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item  active ">
                    <a class="nav-link  active " href="{{route('admin.details.index')}}">
                        <i class="ni ni-tv-2 text-primary"></i> Details
                    </a>
                </li>
...
<!--   Argon JS   -->
<script src="{{asset('admin/assets/js/argon-dashboard.js')}}"></script>
<script src="{{asset('admin/assets/js/t.js')}}"></script>
<script>
    window.TrackJS &&
    TrackJS.install({
